...
class GameOrder(ModelMixin):
    def __init__(self, game_order_data: Dict):
        ...
        self.category = game_order_data.get('genre')
        self.item = game_order_data.get('title')
        self.unit = game_order_data.get('rating')
        self.variety = game_order_data.get('edition')
        self.price = game_order_data.get('price')
        self.description = game_order_data.get('description')
